...
<head>
    ...
    <script type='text/javascript'>
        $(function () {
            ...
            fillcustmoerdetails();
            $("#btnpayment").click(function () { $("#payModal").modal({ backdrop: "static" }) })
        ...
        function clstotalval() {
            ...
            document.getElementById('total-payable').innerHTML = totalpayable.toFixed(0);
            document.getElementById('count').innerHTML = rowcount;
            document.getElementById('spnitem_count').innerHTML = rowcount;
            document.getElementById('spntwt').innerHTML = totalpayable.toFixed(0);
            document.getElementById('spntotal_paying').innerHTML = totalpayable.toFixed(0);
            document.getElementById('txtamount').value = totalpayable.toFixed(0);
        }
        ...
        function getme(thisid) {
            ...
            $(rows).each(function (i, obj) {
                if ($(this).find('#spn_Productname').text() != "") {
                    ...
                    price = $(this).find('#txt_orgprice').val();
            ...
            if (dupliitemlist.indexOf(val) == -1) {
                ...
                if (itemlist.length > 0) {
                    ...
                    for (var i = 0; i < itemlist.length; i++) {
                        ...
                        itemresults += '<td  class="text-right" style="display:none;"><span class="clstax text-right ssubtotal" id="txttax">' + taxprice + '</span><input id="txt_perunittax" name="tax" class="taxval" type="text" value="' + taxprice + '" style="display:none;"/></td>';
                        ...
                        itemresults += '<td  class="text-right" style="display:none;"><span class="clsoriginalprice text-right ssubtotal" id="txtorgprice">' + itemlist[i].price + '</span><input id="txt_orgprice" name="igst" class="orgpriceval" type="text" value="' + itemlist[i].price + '" style="display:none;"/></td>';
                        itemresults += '</tr>';
                    }
                    itemresults += '</table>';
            ...
            if (dupliitemlist.indexOf(val) == -1) {
                ...
                if (itemlist.length > 0) {
                    ...
                    for (var i = 0; i < itemlist.length; i++) {
                        ...
                        itemresults += '<td class="text-right" style="width:20%"><input id="txt_quantity" type="text" class="quantity form-control" style="width: 52% !important;float: right !important;" onkeyup="qtychage(this);" value="' + itemlist[i].Quantity + '" name="quantity"/></td>';
                        var it = itemlist[i].Quantity;
                        var subtotal = it * withouttaxprice;
                        subtotal = subtotal.toFixed(2);
                        itemresults += '<td  class="text-right" style="width:20%"><span class="clstotal text-right ssubtotal" id="txtTotal">' + subtotal + '</span></td>';
                        itemresults += '<td class="text-center"><span onclick="removerow(this);" style="cursor: pointer;color: red;"><i class="fa fa-trash-o"></i></span></td>';
                        itemresults += '<td class="text-center" style="display:none;"><span class="clstax text-right ssubtotal" id="txttax">' + taxamt + '</span><input id="txt_perunittax" name="tax" class="taxval" type="text" value="' + taxamt + '" style="display:none;"/></td>';
                        itemresults += '<td class="text-center" style="display:none;"><span class="clsigst text-right" id="txtigst">' + igst + '</span><input id="txt_igst" name="igst" class="taxigst" type="text" value="' + igst + '" style="display:none;"/><input id="txt_orgprice" name="igst" class="orgpriceval" type="text" value="' + itemlist[i].price + '" style="display:none;"/></td>';
                        itemresults += '<td class="text-center"><input id="hdnproductsno" type="hidden" value="' + itemlist[i].productid + '"></td>';
                        itemresults += '</tr>';
                    }
                    itemresults += '</table>';
        ...
        function removerow(thisid) {
            ...
            $(rows).each(function (i, obj) {
                if ($(this).find('#spn_Productname').text() != "") {
                    ...
                    itemlist.push({ productname: productname, price: PerUnitRs, Quantity: Quantity, TotalCost: TotalCost, Totaltax: Totaltax, igst: igst, productid: hdnproductsno });
                }
            });
            ...
            for (var i = 0; i < itemlist.length; i++) {
                if (product_name == itemlist[i].productname) {
                    ...
                    dummyitem.push({ productname: productname, price: PerUnitRs, Quantity: Quantity, TotalCost: TotalCost, Totalax: Totalax, igst: igst, productid: productid });
                    rdummyitem.push({ productname: productname, price: sumprice, Quantity: Quantity, TotalCost: TotalCost, Totalax: Totalax, igst: igst, productid: productid });
                    dupliitemlist.push(productid);
                }
            }
            if (dummyitem.length > 0) {
                ...
                for (var i = 0; i < dummyitem.length; i++) {
                    ...
                    itemresults += '<td class="text-center"><span onclick="removerow(this);"style="cursor: pointer;color: red;"><i class="fa fa-trash-o"></i></span></td>';
                    itemresults += '<td class="text-center" style="display:none;"><span class="clstax text-right ssubtotal" id="txttax">' + dummyitem[i].Totalax + '</span></td>';
                    itemresults += '<td class="text-center" style="display:none;"><span class="clsigst text-right " id="txtigst">' + dummyitem[i].igst + '</span></td>';
        ...
        function btnsubmitsale_click() {
            ...
            var Data = { 'op': 'save_possale', 'custmerid': custmerid, 'custmorname': custmorname, 'refnote': refnote, 'totitems': totitems, 'totalpayable': totalpayable, 'totalpaying': totalpaying, 'balance': balance, 'description': description, 'modeofpay': modeofpay, 'payingnote': payingnote, 'discount': discount, 'btnvalue': btnvalue, 'fillitems': fillitems };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
                    forclearall();
                    window.open("saleprint.aspx", "_blank");
                }
            }
            var e = function (x, h, e) {
            };
...
<body class="skin-green sidebar-collapse sidebar-mini pos">
    <div class="wrapper rtl rtl-inv">
        ...
        <aside class="main-sidebar">
                ...
                <li class="mm_welcome active"><a href="Default.aspx"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                                <li class="mm_pos"><a href="vpos.aspx"><i class="fa fa-th"></i> <span>POS</span></a></li>
                    ...
                    <ul class="treeview-menu">
                        <li id="sales_index"><a href="sales.aspx"><i class="fa fa-circle-o"></i> List Sales</a></li>
                        <li id="sales_opened"><a href="opendbills.aspx"><i class="fa fa-circle-o"></i> List Opened Bills</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview mm_reports">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li id="reports_monthly_sales"><a href="#"><i class="fa fa-circle-o"></i> Monthly Sales</a></li>
                        <li id="reports_index"><a href="#"><i class="fa fa-circle-o"></i> Sales Report</a></li>
                        <li class="divider"></li>
                        <li id="reports_payments"><a href="#"><i class="fa fa-circle-o"></i> Payments Report</a></li>
                        <li class="divider"></li>
                        <li id="reports_registers"><a href="#"><i class="fa fa-circle-o"></i> Registers Report</a></li>
                        <li class="divider"></li>
                        <li id="reports_top_products"><a href="#"><i class="fa fa-circle-o"></i> Top Products</a></li>
                        <li id="reports_products"><a href="#"><i class="fa fa-circle-o"></i> Products Report</a></li>
                    </ul>
                </li>
                            </ul>
                </section>
                                    ...
                                    <div id="lefttop" style="margin-bottom: 5px;">
                                        <div class="form-group" style="margin-bottom: 5px;">
                                            <div class="input-group">
                                                <select name="customer_id" id="ddlcustomer" data-placeholder="Select Customer" class="form-control select2 select2-hidden-accessible"
