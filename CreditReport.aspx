<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CreditReport.aspx.cs" Inherits="CreditReport" %>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Branchwise Report</h3>
                </div>
                <div class="box-body">
                    <div class="row">
