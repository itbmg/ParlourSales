<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="subdistibutarmaster.aspx.cs" Inherits="subdistibutarmaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function btnsave_click() {
            ...
            var data = { 'op': 'btn_save_subdistibutor', 'parlorname': parlorname, 'parlorcode': parlorcode, 'parlortype': parlortype, 'pramotername': pramotername,
    ...
    <div class="row"  id="divitem" style="display:none;">
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Sub Distibutor Master</h3>
                </div>
                <div class="box-body">
                    <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="well well-sm">
                                     <div class="col-md-4 col-sm-4">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <div class="form-group">
                                                <label for="focus_add_item">Distributor Name</label> 
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <div class="form-group">
                                                <label for="add_customer">Distributor Code</label> 
                                                <input type="text" name="add_customer" value="" class="form-control tip" id="txtparlorcode">
                                            </div>
                                        </div>
                                       <div class="col-md-4 col-sm-4">
                                            <div class="form-group">
                                                <label for="close_register">Distributor Type</label>
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Sub Distibutor Master</h3>
                </div><div style="float: right; padding-right: 14px;padding-bottom: 5px;"><input type="button" name="AddIteam" value="Add SubDistibutor" class="btn btn-primary" id="btnaddclick"></br></div>
