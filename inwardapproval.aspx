<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="inwardapproval.aspx.cs" Inherits="inwardapproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function fillstorereturndtls(msg) {
            ...
            itemresults += '<thead><tr role="row"><th>Sno</th><th scope="col">Date</th><th scope="col">MRN No</th><th scope="col">TotalValue</th><th scope="col">status</th><th scope="col" style="font-weight: bold;">Actions</th></tr></thead></tbody>';
        ...
        function getmethisedit(thisid) {
            ...
            var data = { 'op': 'get_inwordpending_details', 'sno': sno };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        BindGrid(msg);
...
//                document.getElementById('spncname').innerHTML = returntype;
        ...
        function btnapproveclick() {
            ...
            var data = { 'op': 'inward_approveclick', 'sno': sno };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        alert(msg);
