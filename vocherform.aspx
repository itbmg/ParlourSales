   ...
   <link href="autocomplete/jquery-ui.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript">
        ...
        function FillApprovalEmploye() {
            var data = { 'op': 'GetApproveEmployeeNames' };
            var s = function (msg) {
                if (msg) {
                    if (msg == "Session Expired") {
                        alert(msg);
        ...
        function ddlCashToChange(ID) {
            ...
            var data = { 'op': 'GetHeadLimit', 'HeadSno': dlCash };
            var s = function (msg) {
                if (msg) {
                    HeadLimit = msg;
                }
        ...
        function BtnGetVoucherClick() {
            ...
            var data = { 'op': 'BtnGetVoucherClick', 'VoucherID': VoucherID };
            var s = function (msg) {
                if (msg) {
        ...
        function BtnPayVoucherClick() {
            ...
            var data = { 'op': 'BtnPayVoucherClick', 'VoucherID': VoucherID, 'ApprovalAmount': ApprovalAmount, 'Remarks': Remarks, 'Force': Force, 'VoucherType': VoucherType, 'DOE': DOE, 'DenominationString': DenominationString };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
        ...
        function BtnGenerateClick() {
            ...
            var data = { 'op': 'btnViewVoucherGeneretaeClick', 'fromdate': fromdate, 'ToDate': ToDate, 'Type': ddlType, 'BranchID': branchID };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
        ...
        function printvoucher(thisid) {
            var VoucherID = $(thisid).parent().parent().children('.1').html();
            var BranchID = $(thisid).parent().parent().children('.8').html();
            var data = { 'op': 'Get_Voucher_Print_Details', 'VoucherID': VoucherID, 'BranchID': BranchID };
            var s = function (msg) {
                if (msg) {
        ...
        function cancelvoucher(thisid) {
            ...
            if (Status == "Raised") {
                ...
                var data = { 'op': 'btnVoucherCancelClick', 'VoucherID': VoucherID };
                var s = function (msg) {
                    if (msg) {
                        alert(msg);
                    }
...
//            var HeadOfAccount = Head.options[Head.selectedIndex].text;
        ...
        function BtnClearRaiseVoucherClick() {
            ...
            var data = { 'op': 'BtnClearRaiseVoucherClick', 'Description': Description, 'Amount': Amount, 'VoucherType': VoucherType, 'CashTo': CashTo, 'Employee': EmpName, 'AprovedBy': AprovedBy };
            var s = function (msg) {
                if (msg) {
        ...
        function BtnVarifyVoucherSaveClick() {
            ...
            var data = { 'op': 'BtnVarifyVoucherSaveClick', 'VoucherID': VoucherID, 'ReceivedAmount': ReceivedAmount, 'Due': Due };
            var s = function (msg) {
                if (msg) {
        ...
        function get_Others_Details() {
            var data = { 'op': 'get_Others_Details' };
            var s = function (msg) {
                if (msg) {
                    othersnames = msg;
                    var availableTags = [];
        ...
        function btnViewVouchers(VoucherIDs) {
            ...
            var data = { 'op': 'GetBtnViewVoucherclick', 'BranchID': branchID, 'VoucherID': VoucherID };
            var s = function (msg) {
                if (msg) {
                    if (msg == "Session Expired") {
                        alert(msg);
        ...
        function PopupOpens(VocherID) {
            var data = { 'op': 'GetAppriveSubPaybleValues', 'VoucherID': VocherID, 'BranchID': branchID };
            var s = function (msg) {
                if (msg) {
                    $('#divHeads').setTemplateURL('SubPayable.htm');
        ...
        function btnApproveVoucherclicks() {
            ...
            var Status = "A";
            var data = { 'op': 'btnApproveVoucherclick', 'VoucherID': VoucherID, 'BranchID': branchID, 'Approvalamt': Approvalamt, 'AppRemarks': Remarks, 'Status': Status, 'Remarks': Remarks };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
                    $('#divMainAddNewRows').css('display', 'none');
        ...
        function btnRejectVoucherclicks() {
            ...
            var Status = "C";
            var data = { 'op': 'btnRejectVoucherclick', 'VoucherID': VoucherID, 'BranchID': branchID, 'Approvalamt': Approvalamt, 'Remarks': Remarks, 'Status': Status };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
                    $('#divMainAddNewRows').css('display', 'none');
        ...
        function btnVoucherUpdateClicks() {
            ...
            var data = { 'op': 'btnVoucherUpdateClick', 'VoucherID': VoucherID, 'branchID': branchID, 'Remarks': Remarks };
            var s = function (msg) {
                if (msg) {
                    alert(msg);
                    $('#divMainAddNewRows').css('display', 'none');
